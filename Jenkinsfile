node {
    ...
    stage ('Configure') {
        ...
        sleep 30
        sh 'docker exec -i JHG_wordpress wp core install --url=example.com --title=Example --admin_user=supervisor --admin_password=strongpassword --admin_email=info@example.com --allow-root'
