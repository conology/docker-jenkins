node {
    ...
    stage ('Configure') {
        ...
        //sleep 30
        sh 'docker exec -it JHG_wordpress wp core install --url=http://localhost:8080/var/www/wordpress/ --title=Example --admin_user=supervisor --admin_password=strongpassword --admin_email=info@example.com --allow-root'
